...
class Sandbox {
    ...
    SelenideElement s = $(""); // тут нельзя var
    ...
    void utf8() {
        ...
        {
            var button = $("v2345.b12"); // можно использовать только внутри метода
            button.click();
    ...
    void clipboards() {
        ...
        Selenide.clipboard().setText("1234324234"); // отправить текст в буфер обмена
        $("[name=number]").sendKeys(Keys.COMMAND + "v"); // вставить текст из буфера
